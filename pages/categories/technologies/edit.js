...
function Edit_Technology_Form({Edit_technology_integrations,auth_role,item,set_is_refresh_data}){
	...
	return(
        ...
        >
            ...
            <DrawerContent>
            <DrawerCloseButton />
            <DrawerHeader>Edit technology</DrawerHeader>
            <DrawerBody>
                <Image src={item?.cover_image} borderRadius='md' w='full' h='80' objectFit='cover' alt='technology_cover_image' fallbackSrc='../Pro.png'/>
                ...
                {publish_status_info?
                    <Alert status='info' mt='2'>
                        ...
                        <AlertDescription>
                            Toggling this button will directly publish the technology to production without review.
                        </AlertDescription>
                    </Alert>
                    :
                    null
            ...
            <DrawerFooter>
                ...
                {is_retry?
                    <Button bg='gray.500' onClick={handle_edit_technology}>Finish Uploading</Button>
                    :
                    <Button colorScheme='teal' onClick={handle_edit_technology}>Save</Button>
                }
            </DrawerFooter>
            </DrawerContent>
        </Drawer>
...
export default Edit_Technology_Form;

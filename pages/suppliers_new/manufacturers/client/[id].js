...
const Body=()=>{
    ...
    return(
        <Box gap='2' m={{
            ...
            <Delete_Account_Modal is_delete_Modalvisible={is_delete_Modalvisible} set_is_delete_Modal_visible={set_is_delete_Modal_visible} manufacturer_data={client_data} acc_type={"manufacturer"} payload={payload} set_is_refresh={set_is_refresh} is_refresh_data={is_refresh_data}/>
            <SuspendAccountModal issuspendModalvisible={issuspendModalvisible} setissuspendModalvisible={setissuspendModalvisible} manufacturer_data={client_data} acc_type={"manufacturer"} payload={payload} set_is_refresh={set_is_refresh} is_refresh_data={is_refresh_data}/>
            <Un_Suspend_AccountModal is_un_suspend_Modal_visible={is_un_suspend_Modal_visible} set_is_un_suspend_Modal_visible={set_is_un_suspend_Modal_visible} manufacturer_data={client_data} acc_type={"manufacturer"} payload={payload} set_is_refresh={set_is_refresh} is_refresh_data={is_refresh_data}/>
                    ...
                    <Menu>
                        ...
                        <MenuList p='2'>
                            ...
                            {client_data?.verification_status?  
                                ...
                                :
                                (
                                    <MenuItem _hover={{bg:'gray.300',borderRadius:'5',}} onClick={handle_approve_manufacturer}>
                                        <HStack>
                                            <MarkEmailReadIcon/>
                            ...
                            <TabPanels>
                                <TabPanel>
                                    ...
                                    >
                                        ...
                                        <Accordion allowToggle>
                                            {client_data?.distributors?.map((item,index)=>{
                                                return(
                                                    <AccordionItem key={index}>
                                                        <AccordionButton>
                                                            <HStack justify='space-between' flex='1'>
